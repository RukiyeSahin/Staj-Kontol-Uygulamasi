...
# Form implementation generated from reading ui file 'OgrenciSorguu.ui'
#
...
"}")
        ...
        self.tblwOgrSorgu = QtWidgets.QTableWidget(self.centralwidget)
        self.tblwOgrSorgu.setGeometry(QtCore.QRect(20, 280, 1051, 531))
        self.tblwOgrSorgu.setRowCount(100)
        self.tblwOgrSorgu.setColumnCount(26)
        self.tblwOgrSorgu.setObjectName("tblwOgrSorgu")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(20, 20, 391, 241))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(90, 70, 207, 26))
        ...
        self.lneAdiSrg = QtWidgets.QLineEdit(self.layoutWidget)
        self.lneAdiSrg.setCursorMoveStyle(QtCore.Qt.LogicalMoveStyle)
        self.lneAdiSrg.setObjectName("lneAdiSrg")
        self.horizontalLayout.addWidget(self.lneAdiSrg)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "ARADIĞINIZ ÖĞRENCİNİN"))
        self.btnAra.setText(_translate("MainWindow", "ARA"))
        self.label.setText(_translate("MainWindow", "ADI:"))
        self.lneAdiSrg.setPlaceholderText(_translate("MainWindow", "Rukiye Şeklinde Giriş Yapınız.."))
