...
# Form implementation generated from reading ui file 'YerSorguu.ui'
#
...
"}")
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 10, 391, 201))
        self.groupBox.setObjectName("groupBox")
        self.btnAra = QtWidgets.QPushButton(self.groupBox)
        self.btnAra.setGeometry(QtCore.QRect(140, 120, 93, 28))
        self.btnAra.setObjectName("btnAra")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(80, 70, 207, 26))
        ...
        spacerItem = QtWidgets.QSpacerItem(34, 21, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.lneStjYerAdi = QtWidgets.QLineEdit(self.layoutWidget)
        self.lneStjYerAdi.setObjectName("lneStjYerAdi")
        self.horizontalLayout.addWidget(self.lneStjYerAdi)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(20, 820, 231, 31))
        self.label_2.setObjectName("label_2")
        self.lneStjYerOgrSayi = QtWidgets.QLineEdit(self.centralwidget)
        self.lneStjYerOgrSayi.setGeometry(QtCore.QRect(270, 820, 113, 31))
        self.lneStjYerOgrSayi.setObjectName("lneStjYerOgrSayi")
        self.tblwYerSorgu = QtWidgets.QTableWidget(self.centralwidget)
        self.tblwYerSorgu.setGeometry(QtCore.QRect(20, 230, 1061, 571))
        self.tblwYerSorgu.setRowCount(100)
        self.tblwYerSorgu.setColumnCount(26)
        self.tblwYerSorgu.setObjectName("tblwYerSorgu")
        ...
        self.menuStaj_Yeri_Sorgula = QtWidgets.QMenu(self.menuARA)
        self.menuStaj_Yeri_Sorgula.setObjectName("menuStaj_Yeri_Sorgula")
        self.menuCikiss = QtWidgets.QMenu(self.menubar)
        self.menuCikiss.setObjectName("menuCikiss")
        MainWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(MainWindow)
        self.statusbar.setObjectName("statusbar")
        MainWindow.setStatusBar(self.statusbar)
        self.menuOgr = QtWidgets.QAction(MainWindow)
        self.menuOgr.setObjectName("menuOgr")
        self.menuStajDnm = QtWidgets.QAction(MainWindow)
        self.menuStajDnm.setObjectName("menuStajDnm")
        self.menuStjYerIli = QtWidgets.QAction(MainWindow)
        self.menuStjYerIli.setObjectName("menuStjYerIli")
        self.menuStjYerAdi = QtWidgets.QAction(MainWindow)
        self.menuStjYerAdi.setObjectName("menuStjYerAdi")
        self.menuCikis = QtWidgets.QAction(MainWindow)
        self.menuCikis.setObjectName("menuCikis")
        self.menuStaj_Yeri_Sorgula.addAction(self.menuStjYerIli)
        self.menuStaj_Yeri_Sorgula.addAction(self.menuStjYerAdi)
        self.menuARA.addAction(self.menuOgr)
        self.menuARA.addAction(self.menuStajDnm)
        self.menuARA.addAction(self.menuStaj_Yeri_Sorgula.menuAction())
        self.menuCikiss.addAction(self.menuCikis)
        self.menubar.addAction(self.menuARA.menuAction())
        self.menubar.addAction(self.menuCikiss.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "STAJ YERİNİN"))
        self.btnAra.setText(_translate("MainWindow", "ARA"))
        self.label.setText(_translate("MainWindow", "ADI:"))
        self.lneStjYerAdi.setPlaceholderText(_translate("MainWindow", "Akınsoft"))
        self.label_2.setText(_translate("MainWindow", "Burada Staj Yapan Öğrenci Sayısı:"))
        self.menuARA.setTitle(_translate("MainWindow", "ARA"))
        self.menuStaj_Yeri_Sorgula.setTitle(_translate("MainWindow", "Staj Yeri Sorgula"))
        self.menuCikiss.setTitle(_translate("MainWindow", "ÇIKIŞ"))
        self.menuOgr.setText(_translate("MainWindow", "Öğrenci Sorgula"))
        self.menuStajDnm.setText(_translate("MainWindow", "Staj Dönemi Sorgula"))
        self.menuStjYerIli.setText(_translate("MainWindow", "Staj Yeri İline Göre"))
        self.menuStjYerAdi.setText(_translate("MainWindow", "Staj Yeri Adına Göre"))
