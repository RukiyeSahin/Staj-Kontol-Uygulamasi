...
# Form implementation generated from reading ui file 'DonemSorggu.ui'
#
...
"}")
        ...
        self.tblwDonOgr = QtWidgets.QTableWidget(self.centralwidget)
        self.tblwDonOgr.setGeometry(QtCore.QRect(20, 240, 1061, 531))
        self.tblwDonOgr.setRowCount(100)
        self.tblwDonOgr.setColumnCount(26)
        self.tblwDonOgr.setObjectName("tblwDonOgr")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(20, 10, 401, 211))
        self.groupBox.setObjectName("groupBox")
        self.btnAra_2 = QtWidgets.QPushButton(self.groupBox)
        self.btnAra_2.setGeometry(QtCore.QRect(140, 110, 93, 28))
        self.btnAra_2.setObjectName("btnAra_2")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(80, 60, 230, 26))
        ...
        self.lneDonYil = QtWidgets.QLineEdit(self.layoutWidget)
        self.lneDonYil.setObjectName("lneDonYil")
        self.horizontalLayout_3.addWidget(self.lneDonYil)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "STAJ DÖNEMİ"))
        self.btnAra_2.setText(_translate("MainWindow", "ARA"))
        self.label_3.setText(_translate("MainWindow", "Dönem Giriniz:"))
        self.lneDonYil.setPlaceholderText(_translate("MainWindow", "2020-2021 "))
